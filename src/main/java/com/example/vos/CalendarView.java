...
public class CalendarView extends Application {
    ...
    public void start(Stage primaryStage) {
        if (!isWindowOpen) {
            ...
            Image previousImage = new Image(getClass().getResourceAsStream("/com/example/vos/assets/icons/back.png"));
            Image nextImage = new Image(getClass().getResourceAsStream("/com/example/vos/assets/icons/next.png"));
            ...
            String cssPath = getClass().getResource("/com/example/vos/assets/calendar.css").toExternalForm();
