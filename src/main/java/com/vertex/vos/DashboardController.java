...
public class DashboardController implements Initializable {
    ...
    public void loadIOpsContent(MouseEvent mouseEvent) {loadContent("InternalOperationsContent.fxml");}
    public void loadEOpsContent(MouseEvent mouseEvent) {loadContent("ExternalOperationsContent.fxml");}
    public void loadFSContent(MouseEvent mouseEvent) {loadContent("FinancialStatementContent.fxml");}
    public void loadCalendarContent(MouseEvent mouseEvent) {loadContent("CalendarContent.fxml");}
