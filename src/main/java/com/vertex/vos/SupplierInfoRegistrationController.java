...
import static com.vertex.vos.TextFieldUtils.addNumericInputRestriction;
...
public class SupplierInfoRegistrationController implements Initializable, DateSelectedCallback {
    ...
    private void initializeAddress() {
        provinceComboBox.setItems(FXCollections.observableArrayList(LocationCache.getProvinces()));
        cityComboBox.setItems(FXCollections.observableArrayList(LocationCache.getCities()));
        baranggayComboBox.setItems(FXCollections.observableArrayList(LocationCache.getBarangays()));
    }
