...
public class SalesInvoicesController implements Initializable {
    ...
    private void openSalesInvoice(SalesInvoiceHeader salesInvoiceHeader) {
        try {
            ...
            stage.setTitle("Order#" + salesInvoiceHeader.getOrderId());
    ...
    private void setUpTable() {
        ...
        TableColumn<SalesInvoiceHeader, Integer> invoiceType = new TableColumn<>("Invoice Type");
        invoiceType.setCellValueFactory(cellData -> new SimpleIntegerProperty(cellData.getValue().getType()).asObject());
        ...
        invoiceType.setCellFactory(col -> new TableCell<SalesInvoiceHeader, Integer>() {
            @Override
